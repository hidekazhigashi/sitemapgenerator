...
現在は新規プロジェクトのため、ドキュメントはまだ作成されていません。
以下のドキュメントが段階的に作成される予定です：

- `rules/coding-standards.md` - コーディング規約
- `rules/architecture.md` - アーキテクチャ設計  
- `rules/patterns.md` - 実装パターンとベストプラクティス
- `rules/troubleshooting.md` - トラブルシューティングガイド
- `docs/api.md` - API仕様書
...
- **推奨される分割方法**:
  - `rules/update-system.md` - 更新システムのルール
  - `rules/project-specific.md` - プロジェクト固有の設定
  - `rules/references.md` - 参照すべきドキュメントのリスト
...
### 更新履歴
- 2025-08-16: 初期設定、ドキュメント自動更新システム導入